...
public class ArticoloServiceImpl implements ArticoloService {
	...
	public void delete(Articolo o) throws Exception {
		...
		try {
			...
			// eseguo quello che realmente devo fare
			if(articoloDAO.verificaSeArticoloHaCategorie(o.getId())== true)
				articoloDAO.delete(o);
			else
				throw new CustomException("Impossibile eliminare articolo con categorie al suo interno.");
	...
	public long voglioSommaDiArticoliMarioRossi() throws Exception {
		...
		try {
			...
			// eseguo quello che realmente devo fare
			return articoloDAO.voglioSommaDiArticoliMarioRossi();
		} catch (Exception e) {
			e.printStackTrace();
			throw e;
		} finally {
